          ...
          {clients.map((client) => (
            <tr key={client.id}>
              ...
              <td className='py-0 px-3 w-5'>
                <button className='inline-block rounded-2xl py-2 px-3 btn-update'>Update</button>
              </td>
              <td className='py-0 px-3 w-5'>
                <button className='inline-block rounded-2xl py-2 px-3 btn-delete'>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
